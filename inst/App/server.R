...
#------------------rightPanel--------------------------------
  ...
  source("rightPanel/choiceSet/serverColSetDB.R",                local=TRUE)
  ...
  source("rightPanel/mouse/serverMouseCmdFindPoint.R",           local=TRUE)
  ...
  source("rightPanel/choiceSet/modalCustColumn.R",               local=TRUE)
