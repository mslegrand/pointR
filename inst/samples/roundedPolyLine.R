...
ptR<-list(
  x=matrix(
    c(c( 100,100 ),c( 100,400 ),c( 300,400 ),c( 233.5,314 )),
  2,),
  y=matrix(
    c(c( 202.5,211 ),c( 207.5,89 ),c( 319.5,90 ),c( 327.5,207 ),c( 403.5,196 ),c( 443.5,93 ),c( 498.5,299 ),c( 465.5,364 )),
  2,),
  z=matrix(
    c(c( 333.5,450 ),c( 399.5,353 )),
  2,)
)
